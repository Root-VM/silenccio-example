...
import css from "./accorrdion-item-resolved.module.scss";
...
const AccordionDashboardItemResolved: FC<{isOpenA: boolean, data: any, list: any[], onUpdate: () => void}> = ({isOpenA, data, list, onUpdate}) => {
...
export default AccordionDashboardItemResolved;

...
const OnboardingFiveForm: FC = () => {
    return (
        <form className={css.wrap}>
            ...
            <p className={css.title}>Onboarding - Step 5/5</p>
            <p className={css.text}>Wie lautet Ihre geschäftliche E-Mail-Adresse?</p>
            ...
            <Input className="myInput" placeholder='E-mail@adresse.ch' type='email' />
            ...
            <div className={css.group}>
                <button className={cn('myBtn', 'small', css.btn)}>SCAN STARTEN</button>
